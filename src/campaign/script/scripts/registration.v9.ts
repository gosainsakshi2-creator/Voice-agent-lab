 ...
 * IN 10 MINUTES", 22 September 2026, 7:30 PM IST. Revision 9.
 *
 * A NEW immutable version. v1-v8 stay byte-identical, so every campaign
 ...
 * paraphrased gate ("kya main" + "seat reserve"); `registration-v9-tests`
 ...
 * both directions against the real classifier (`registration-v9-tests`
 ...
 *
 * NO DURATION, NO PLATFORM, NO SPEAKER, NO REPLAY POLICY, NO BONUS, NO
 * COMPANY FIGURES, NO EARNINGS. None of these was supplied with the
 * approved wording, and none exists in a form this campaign can
 * confirm, so the answers below say so rather than guess.
 *
 * NO PROMISE ABOUT WHICH CHANNEL. The webinar's joining details reach a
 * registered person from FlexiFunnels through the contact details it
 * already has for them (the imported name, phone and email). The agent
 * may say that and may not say more: it does not send anything itself,
 * does not name a time it will arrive, and does not offer to "send the
 * details" in place of reserving the seat.
 *
...
export const REGISTRATION_V9: CampaignScript = {
  id: "registration",
  version: "v9",
  campaignType: "registration",
  label: "Registration v9 (Launch Your Business Online in 10 Minutes webinar, 22 September 7:30 PM)",
  ...
  systemPromptAppendix: [
    ...
    "  point of it.",
    "- \"How long is it?\" — you do not have the exact duration. Say so plainly, and give what",
    "  you do have: it is a live session starting at 7:30 PM on 22nd September.",
    "- \"Send me the details on WhatsApp.\" — once their seat is reserved, the webinar details",
    "  reach them from FlexiFunnels on the contact details it already has for them. You do not",
    "  send anything yourself, and you do not promise a channel or a time. Offer to reserve the",
    "  seat if they would like one; if they would rather leave it, close warmly.",
    ...
    "long it runs, which platform it is on, who is speaking, whether there is a recording, what",
    "anything costs afterwards — do not guess and do not reason your way to a likely answer.",
    ...
    "",
    "Then carry on. Never invent a date, a time, a link, a price, a bonus, a duration, a",
    "platform, a guarantee, a registration number, a replay policy or a claim about",
    "FlexiFunnels.",
    "",
    "--- SCRIPT ---",
    "",
