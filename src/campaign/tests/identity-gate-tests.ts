...
await test("A1b. the SPACED and UNSPACED spellings of the same word agree", () => {
...
await test("D2b. ...and Deepgram's UNSPACED 'Haanji.' confirms exactly as the spaced one does", async () => {
