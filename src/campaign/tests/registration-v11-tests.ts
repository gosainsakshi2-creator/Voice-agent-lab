...
test("A2. v11 is STILL not the default — a different event from v6, and a newer revision of v10", () => {
  // The default is the workshop script: v6 when v11 shipped, and since
  ...
  // ...but it is selectable, listed after the workshop scripts and
  // ahead of v10 and v9, exactly as v8 sits ahead of v7.
